...
namespace Naninovel
{
    ...
    public class UIManager : IUIManager, IStatefulService<SettingsStateMap>
    {
        ...
        public virtual string Font { get => ObjectUtils.IsValid(customFont) ? customFont.name : null; set => SetFont(value); }
        ...
        public virtual async UniTask<IManagedUI> InstantiatePrefabAsync (GameObject prefab)
        {
        ...
        public virtual IManagedUI GetUI (string prefabName)
        {
            foreach (var managedUI in managedUI)
